...
private:
    ...
    void loadModel(std::string const &path)
    {
        ...
        const aiScene *scene =
            importer.ReadFile(path, aiProcess_Triangulate | aiProcess_GenSmoothNormals | aiProcess_CalcTangentSpace | aiProcess_FlipUVs);
        // check for errors
...
{
    std::string filename;
    filename.append(directory).append("/").append(path);
